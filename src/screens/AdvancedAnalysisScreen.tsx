...
// Mock Progress Component (falls react-native-progress nicht funktioniert)
const MockProgressBar = ({ progress, width, height, color }: any) => (
  <View style={{ 
    width, 
    height, 
...
const MockProgressCircle = ({ progress, size, color, children }: any) => (
  <View style={{
    width: size,
    height: size,
    borderRadius: size / 2,
                  ...
                  <>
                    <View style={styles.metricItem}>
                      ...
                      <MockProgressCircle
                        ...
                        color="#4ECDC4"
                      >
                        <Text style={styles.metricValue}>{skinResult.hydration || 0}%</Text>
                      </MockProgressCircle>
                    </View>
                    <View style={styles.metricItem}>
                      ...
                      <MockProgressCircle
                        ...
                        color="#FFE66D"
                      >
                        <Text style={styles.metricValue}>{skinResult.oiliness || 0}%</Text>
                      </MockProgressCircle>
                    </View>
                    <View style={styles.metricItem}>
                      ...
                      <MockProgressCircle
                        ...
                        color="#FF6B6B"
                      >
                        <Text style={styles.metricValue}>{skinResult.sensitivity || 0}%</Text>
                      </MockProgressCircle>
                    </View>
                  </>
                ) : (
                  <>
                    <View style={styles.metricItem}>
                      ...
                      <MockProgressCircle
                        ...
                        color="#FF6B6B"
                      >
                        <Text style={styles.metricValue}>{hairResult.damage || 0}%</Text>
                      </MockProgressCircle>
                    </View>
                    <View style={styles.metricItem}>
